...
Mobile.setText(findTestObject('android.widget.EditText - Input Name'), 'MST QA Test', 0)

Mobile.pressBack()

Mobile.tap(findTestObject('android.widget.EditText - Choose Type'), 0)
...
Mobile.setText(findTestObject('android.widget.EditText - Input Description'), 'Testing', 0)
