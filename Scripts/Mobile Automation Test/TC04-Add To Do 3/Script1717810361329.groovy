...
Mobile.setText(findTestObject('android.widget.EditText - Input Name'), 'MST QA Test 4', 0)
...
Mobile.setText(findTestObject('android.widget.EditText - Input Description'), 'Testing 4', 0)
